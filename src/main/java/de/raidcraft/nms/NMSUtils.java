...
// * @author jetp250
// */
//// TODO: abstract this into interface and separate nms packages
...
//     */
//    public static void registerEntity(Type type, Class<?> customClass, boolean override) {
...
//        MinecraftKey key = new MinecraftKey(name);
//        EntityTypes.b.a(type.id, key, (Class<? extends Entity>) customClass);
//        EntityTypes.d.add(key);
...
//     */
//    @SuppressWarnings("unchecked")
//    public static void registerEntity(String name, Type type, Class<?> customClass, boolean override) {
//        MinecraftKey key = new MinecraftKey(name);
//        EntityTypes.b.a(type.getId(), key, (Class<? extends Entity>) customClass);
//        EntityTypes.d.add(key);
...
//
//        Attributes(String nmsName, IAttribute nmsAttribute) {
//            this.name = nmsName;
...
//        Iterator<BiomeBase> iterator = BiomeBase.aG.iterator();
//        int index = 0;
