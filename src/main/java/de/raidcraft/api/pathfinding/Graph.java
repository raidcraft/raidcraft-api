...
public class Graph {
    ...
    public Graph(int nbrNodes) {
        ...
        nodes = new HashMap<>(nbrNodes);
        edgeLists = new HashMap<>(nbrNodes);
    }
    ...
    public boolean removeNode(int nodeID) {
        ...
        ArrayList<GraphEdge> edgesToRemove = new ArrayList<>();
    ...
    protected void rememberFloatingEdge(int id, FloatingEdge floatEdge) {
        ...
        if (nodesToBe == null) {
            nodesToBe = new HashMap<>();
        }
        if (!nodesToBe.containsKey(id)) {
            nodesToBe.put(id, new LinkedList<>());
        }
