...
public class GraphSearch_Astar implements IGraphSearch {
    ...
    private void makeDataStores(int nbrNodes) {
        ...
        settledNodes = new HashSet<>(nbrNodes);
        parent = new HashMap<>(nbrNodes);
        graphCostToNode = new HashMap<>(nbrNodes);
        fullCostAtNode = new HashMap<>(nbrNodes);
        unsettledNodes = new PriorityQueue<>(nbrNodes);
        examinedEdges = new HashSet<>();
