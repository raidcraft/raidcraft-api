...
public class ProjectileScheduler implements Runnable, IProjectile, CustomProjectile {
    ...
    public ProjectileScheduler(String name, org.bukkit.entity.Entity e, LivingEntity shooter, float power, Plugin plugin) {
        ...
        this.e.setPositionRotation(shooter.getLocation().getX(), shooter.getLocation().getY() + 1.5, shooter.getLocation().getZ(), shooter.getLocation().getYaw(), shooter.getLocation().getPitch());
    ...
    public void run() {
        ...
        if (movingobjectposition != null)
            vec3d1 = e.world.getVec3DPool().create(movingobjectposition.pos.c, movingobjectposition.pos.d, movingobjectposition.pos.e);
