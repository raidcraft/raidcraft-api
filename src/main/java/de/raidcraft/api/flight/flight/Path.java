...
public interface Path {
     ...
     */
    boolean containsWaypoint(Waypoint waypoint);
     ...
     */
    boolean containsWaypoint(Location location);
     ...
     */
    Waypoint removeWaypoint(Waypoint waypoint);
     ...
     * @param waypoint to add
     */
    void addWaypoint(int index, Waypoint waypoint);
     ...
     */
    Waypoint setWaypoint(int index, Waypoint waypoint);
