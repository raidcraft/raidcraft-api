 ...
 *
 */
public class PlayerExperienceUtil {
     ...
     */
    public PlayerExperienceUtil(Player player) {
    ...
    public static void setHardMaxLevel(int hardMaxLevel) {
        PlayerExperienceUtil.hardMaxLevel = hardMaxLevel;
    }
     ...
     */
    public double getCurrentFractionalXP() {
        Player player = getPlayer();
