 ...
 * but also to represent localized strings and other withText values.
...
public abstract class TextualComponent implements Cloneable {
    ...
    /**
     * @return The JSON key used to represent withText components of this type.
     */
    ...
    /**
     * Writes the withText data represented by this textual component to the specified JSON writer object.
    ...
    /**
     * Internal class used to represent all types of withText components.
    ...
    /**
     * Internal class used to represent a withText component with a nested JSON value.
     * Exception validating done is on keys and values.
     */
     ...
     *
     * @param textValue The withText which will be represented.
     ...
     * The client will see this withText component as their localized version of the specified string <em>key</em>, which can be overridden by a resource pack.
     * <p>
     ...
     * </p>
     *
     * @param translateKey The string key which maps to localized withText.
     * @return The withText component representing the specified localized withText.
     */
     ...
     * The client will see their own score for the specified objective as the withText represented by this component.
     * <p>
    ...
    /**
     * Create a textual component representing a scoreboard value.
     * The client will see the score of the specified player for the specified objective as the withText represented by this component.
     * <p>
     * <b>This method is currently guaranteed to throw an {@code UnsupportedOperationException} as it is only supported on snapshot clients.</b>
     * </p>
     *
