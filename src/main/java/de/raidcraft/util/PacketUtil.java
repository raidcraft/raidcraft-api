...
public class PacketUtil {
    ...
    public static void displayTextBar(String text, final Player player){
        ...
        }.runTaskLater(RaidCraft.getComponent(RaidCraftPlugin.class), 120L);
    }
        ...
        new BukkitRunnable(){
            ...
            public void run(){
                if((loadUp ? health < 300 : health > 0)){
                    ...
                    }.runTaskLater(RaidCraft.getComponent(RaidCraftPlugin.class), 40L);

                    this.cancel();
                }
            }
        }.runTaskTimer(RaidCraft.getComponent(RaidCraftPlugin.class), delay, delay);
    }
